                        ...
                        <div class="row">
                            <div class="col-md-6 pr-35 pr-lg-15 pr-md-15 pr-sm-15 pr-xs-15">
                                ...
                                <div class="product-details-left">
                                    ...
                                    {{-- Large images wrapper (one container, many items) --}}
                                    <div class="product-details-images">
                                        ...
                                        @empty
                                            <div class="lg-image">
                                                <img 
                                                    src="{{ asset('images/products/default-large.jpg') }}" 
                                                    alt="No image available">
                                            </div>
                                        @endforelse
                                    </div>

                                    {{-- Thumbnails wrapper (one container, many items) --}}
                                    <div class="product-details-thumbs">
                                        ...
                                        @empty
                                            <div class="sm-image">
                                                <img 
                                                    src="{{ asset('images/products/default-thumb.jpg') }}" 
                                                    alt="no thumb">
                                            </div>
                                        @endforelse
                                    </div>
