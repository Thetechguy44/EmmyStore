                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route('update.banner', $banner->id) }}" method="POST" enctype="multipart/form-data" id="productForm">
                                @csrf
                                @method('PUT')
                                <div class="col-md-6">
                                    <div class="mb-3">
                                ...
                                <div class="mb-4 col-md-6">
                                    <img src="{{ asset('images/banners/' . $banner->image_path) }}" alt="Banner Image" class="img-fluid">
                                </div>
