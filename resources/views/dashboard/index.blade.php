                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-shrink-0 align-self-center">
                                            ...
                                            <div class="align-content-center text-center border border-dashed rounded-circle p-1">
                                                <img src="backend/assets/images/users/user-12.jpg" class="avatar avatar-sm rounded-circle">
                                            </div>
                                            <!-- End Avatar -->
                                        </div>
                            ...
                            <div class="table-responsive table-card mt-0">
                                <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="backend/assets/images/users/user-12.jpg" class="avatar avatar-sm rounded-circle me-3"> John Hamilton
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="backend/assets/images/users/user-11.jpg" class="avatar avatar-sm rounded-circle me-3"> Janice Reese
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="backend/assets/images/users/user-13.jpg" class="avatar avatar-sm rounded-circle me-3"> Andrew Kim
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="backend/assets/images/users/user-14.jpg" class="avatar avatar-sm rounded-circle me-3"> Kathryn Sanchez
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="backend/assets/images/users/user-15.jpg" class="avatar avatar-sm rounded-circle me-3"> Diane Richards
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="backend/assets/images/users/user-12.jpg" class="avatar avatar-sm rounded-circle me-3"> Chung Ohearn
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="backend/assets/images/users/user-14.jpg" class="avatar avatar-sm rounded-circle me-3"> John Shan
                                            </td>
